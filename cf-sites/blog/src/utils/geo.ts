...
const M8_COVERAGE_HUBS: CuratedLink[] = [
  ...
  {
    key: 'hk-platforms-devices',
    path: '/hk-tech-dividend',
    fallbackTitle: '港股平台 / 消费电子 / 出海制造',
    fallbackSummary: '承接平台互联网、消费电子、智能硬件、出海制造和估值切换相关的港股主线。',
    intent: 'sector-slice',
    keywords: ['港股', '平台互联网', '消费电子', '智能硬件', '出海制造'],
  },
  {
    key: 'hk-dividend-energy',
    path: '/article/cnooc-0883hk-oil-dividend-q22026-deep',
    fallbackTitle: '港股高股息 / 能源 / 防御资产',
    fallbackSummary: '承接高股息能源、电信、防御资产和现金流定价逻辑的港股入口。',
    intent: 'sector-slice',
    keywords: ['港股', '高股息', '能源', '电信', '防御资产'],
  },
  {
    key: 'hk-southbound-insurance',
    path: '/hk-tech-dividend',
    fallbackTitle: '港股保险 / 南向资金 / 估值比较',
    fallbackSummary: '承接保险、南向资金、AH 比价和港股流动性风格切换的观察入口。',
    intent: 'sector-slice',
    keywords: ['港股', '保险', '南向资金', 'AH 比价', '估值'],
  },
  {
    key: 'crypto-etf-liquidity',
    path: '/btc-etf-watch',
    fallbackTitle: '区块链 / BTC ETF / 流动性',
    fallbackSummary: '承接 BTC ETF 资金流、比特币风险偏好、美元流动性和跨资产传导。',
    intent: 'sector-slice',
    keywords: ['区块链', 'BTC ETF', '资金流', '流动性', '比特币'],
  },
  {
    key: 'crypto-exchange-infra',
    path: '/article/cme-crypto-index-futures-20260609-insight',
    fallbackTitle: '区块链 / 交易所 / 托管基础设施',
    fallbackSummary: '承接交易所、托管、期货指数、合规基础设施和加密市场制度层。',
    intent: 'sector-slice',
    keywords: ['区块链', '交易所', '托管', 'CME', '基础设施'],
  },
  {
    key: 'crypto-base-beta',
    path: '/article/coinbase-base-layer2-ecosystem-2026-deep',
    fallbackTitle: '区块链 / Base 生态 / 链上应用',
    fallbackSummary: '承接 Base、Layer2、链上应用和平台型加密生态的长期覆盖入口。',
    intent: 'sector-slice',
    keywords: ['区块链', 'Base', 'Layer2', '链上生态', '应用'],
  },
  {
    key: 'crypto-treasury-beta',
    path: '/article/mstr-btc-treasury-may2026-deep',
    fallbackTitle: '区块链 / Treasury Beta / 杠杆敞口',
    fallbackSummary: '承接 MSTR 等 Treasury Beta、杠杆敞口和加密风险偏好放大的阅读入口。',
    intent: 'sector-slice',
    keywords: ['区块链', 'Treasury Beta', 'MSTR', '杠杆', '风险偏好'],
  },
];
